        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative glass-card">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="h-80 sm:h-96 md:h-[28rem] w-full relative rounded-lg overflow-hidden border border-primary/10">
              <iframe width="100%" height="100%" src="/s1.mp4"></iframe>
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative glass-card">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="h-80 sm:h-96 md:h-[28rem] w-full relative rounded-lg overflow-hidden border border-primary/10">
                <iframe width="100%" height="100%" src="/s2.mp4"></iframe>
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative glass-card">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="h-80 sm:h-96 md:h-[28rem] w-full relative rounded-lg overflow-hidden border border-primary/10">
                <iframe width="100%" height="100%" src="/s3.mp4"></iframe>
              </div>
      ...
      <footer className="mt-auto py-4 border-t border-muted/30">
        <div className="container mx-auto px-4 flex flex-col items-center justify-center">
          <p className="text-primary text-center text-sm">
            Assembled codon by codon by Lakshya Agarwal 🔧🧬
          </p>
